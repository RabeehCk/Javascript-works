...
// 2 ==========================================================
// var runtime = films.filter(p => p.runtime<140).map(p => p.title)
// console.log(runtime);


// 3 ============================================================
// var highRuntime = films.reduce((p1,p2) => Number(p1.runtime)>Number(p2.runtime) ? p1:p2)
// console.log(highRuntime.title);


// 4 ============================================================
// var lowRuntime = films.reduce((p1,p2) => Number(p1.runtime)<Number(p2.runtime) ? p1:p2)
// console.log(lowRuntime.title);


// 5 ==========================================================
// var yearCount = {}
// for(let ch of films){
//     if(ch.year in yearCount){
//         yearCount[ch.year] += 1
//     }
//     else{
//         yearCount[ch.year] = 1
...
// 6 ========================================================
// var actionMovies = films.filter(p => p.genres.includes("Action")).map(p => p.title)
// console.log(actionMovies);

// for(let ch of films){
//     if(ch.genres.includes("Action")){
...
// 7 ========================================================
// var actionDramaMovies = films.filter(p => p.genres.includes("Action") || p.genres.includes("Drama")).map(p => p.title)
...
var yearCount = {}
for(let ch of films){
    ch.year in yearCount ? yearCount[ch.year]+=1 : yearCount[ch.year]=1
}
var nestedArray = Object.entries(yearCount)
var mostMoviesYear = nestedArray.reduce((p1,p2) => p1[1]>p2[1] ? p1:p2)
